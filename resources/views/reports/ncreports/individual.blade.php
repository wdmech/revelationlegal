...
<p>The Individual Report is the second tab that you will see in the Reports section, and it is
...
Email Address, Employee ID, Group, Position, Department, and Location.</p>

<p>If you scroll down on your screen, the next thing that you will see is a donut chart. This chart
will tell you what activities the user takes part in (either legal or support), and how much of their
time is allocated to each activity. This chart is unique to each individual’s report. The <strong>Green
aspect of the chart represents Support Activities</strong>, while the <strong>Blue aspect of the chart
represents Legal Activities</strong>.</p>
<img src="{{asset('imgs/user-guide/image-030.png')}}" alt="img">
<p>Directly next to this chart, you will find a section of the report titled “<strong>Time by Classification</strong>”.
...
how the employee’s time was allocated across what we call Classifications. Classification is a
layer in our taxonomy, and it is at a high level– it tells you where a specific employee spends the
majority of their time.</p>

<p>Further down the report, you will see a type of bar graph titled “<strong>Time by Substantive Area</strong>”.
...
do a little, or a lot of.</p>
<img src="{{asset('imgs/user-guide/image-031.png')}}" alt="img">
<p>The final part of the Individual Report is the <strong>Complete Time Breakdown</strong>. This is the complete
...
each of these categories by clicking the triangle-shaped arrow directly next to the title of activity.</p>

<p>It is important to note that this is not the entire taxonomy as a whole, this is simply the taxonomy
...
<p>Percentages are calculated based on their survey responses. On the right to the percentage, you
...
meaning that the individual is involved in this activity a minimal amount.</p>

<p>Should you wish to print any of this information, or save it as a PDF file, you may do so at the
top of the report. It will be listed with the project name.</p>
<img src="{{asset('imgs/user-guide/image-033.png')}}" alt="img">  
...
<div class="container-fluid px-3 hideinhelppdf ">
    ...
    <div id="individualContent">
        ...
        <div class="fourth_part" style="background:white;">
            <div style="width:100%;padding:20px 0;padding-bottom:0;">
                ...
                <div id="individualReportContainer" style="display:none;background:white;z-index:10;padding-top:20px;">
                    ...
                    <div class="px-md-3 mt-10" style="background: white;">
        ...
        <div class="third_part" style="display: none;">
            <div class="py-8 px-md-3 overflow-x-auto" style="padding-top:0.6rem;">
