...
<body class="font-sans antialiased">
    ...
    <div class="entrymain-content flex dark:bg-gray-900 flex-wrap" :class="{ 'overflow-hidden': isSideMenuOpen }" style="min-height: 100vh;">
    ...
    <div class="site-footer"> 
        <div class="row footer-inner"> 
            <div class="col-12 col-md-9"> 
                ...
                In response to this need, ofPartner has developed RevelationLegal, a powerful,web-based analysis designed for the legal environment that provides unprecedented vision into a firm's operation.
