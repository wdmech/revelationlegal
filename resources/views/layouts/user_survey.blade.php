...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>  
        @if(isset($survey) && isset($settings))
            <div class="row">
                ...
                <div class="col-md-9 text-right my-auto surveypdfhide"> 
            ...
            <div class="row">
                <div class="col text-center">
                        ...
                        @if(isset($settings))
                            {!! $settings->footer !!}  
                        @else
                        <div class="surveypdfhide">For survey instructions please refer to the <a href="{{ route('guides.participants') }}">Participant Guide</a></div>
