...
<aside class=" z-20 hidden overflow-y-auto shadow-md bg-white dark:bg-gray-800 md:block flex-shrink-0" id="desktop_sidebar">
    <div class="sidebar-menus anchor" style="height:100%;">
        ...
        <ul class="">
            ...
            <li class="">
                <a class="@if(Route::currentRouteName() == 'help-desk') active @endif inline-flex text-gray-500 items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="{{ route('help-desk') }}">
                <i class="fa fa-book" aria-hidden="true"></i>
                    <span class="">Manage Help Content</span> 
                </a>
            </li> 
            <li class="">
                <a class="@if(Route::currentRouteName() == 'manage-guide') active @endif inline-flex text-gray-500 items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="{{ route('manage-guide') }}">
                <i class="fa fa-tasks" aria-hidden="true"></i>
                    <span class="">Manage Help guide</span>  
                </a>
            </li> 
        </ul>
        @endif
