...
Route::get('/uploadtaxanomy',function(){
    return view('taxonomy.uploadexcel');
});
Route::post('/uploadtaxanomyData',[\App\Http\Controllers\TaxonomyController::class, 'uploadtaxanomyData'])->name('taxanomy-upload');
...
Route::get('/managehelpguide', function () {
    return view('managehelpguide');
})->name('manage-guide'); 
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::post('/update-help-guide', [HelpManagerController::class, 'update_helpguide'])->name('update-help-guide'); 
